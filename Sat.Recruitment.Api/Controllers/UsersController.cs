...
namespace Sat.Recruitment.Api.Controllers
{
    ...
    public partial class UsersController : ControllerBase
    {
        ...
        public async Task<ResultDTO<User>> CreateUser(UserCreateCommand userCreateData)
        {
            return await mediator.Send(userCreateData);
        }

        [HttpGet("/list-user")]
        public async Task<ResultDTO<User>> ListUser()
        {
